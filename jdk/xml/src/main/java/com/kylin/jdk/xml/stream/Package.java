...
public interface Package {
	 ...
	 * 
	 * StaX is a Pull-Parsing model. Application can take the control over parsing the XML documents by pulling (taking) 
	 * the events from the parser. 
	 * 
	 ...
	 * 
	 * The Cursor API
	 *   The main interfaces: XMLStreamReader, XMLStreamWriter 
	 * 
	 * 
	 * 
	 * 
